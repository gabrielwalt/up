...
export default function transform(hookName, element, payload) {
  if (hookName === TransformHook.beforeTransform) {
    ...
    // Remove hidden modal dialogs (e.g., "Request a Speaker" form modal on leadership page)
    // These are display:none overlays that shouldn't be imported as visible content
    WebImporter.DOMUtils.remove(element, [
      '.modal'
    ]);
